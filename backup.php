...
// $backupFileName = 'DMS_backup_' . date('Y-m-d') . '.sql';
// $backupPath = '/path/to/backup/folder/' . $backupFileName;

// // Execute the database backup command
// $command = "mysqldump --opt -h {$host} -u {$username} -p{$password} {$database} > {$backupPath}";
